                        ...
                        <div class="tourmaster-tour-search-item-wrap">
                            <div class="tourmaster-tour-search-item clearfix tourmaster-style-full tourmaster-column-count-8 tourmaster-item-pdlr tourmaster-input-style-default tourmaster-tour-search-item-style-2">
                                <div class="tourmaster-tour-search-wrap clearfix tourmaster-with-frame">
                                    <form class="tourmaster-form-field tourmaster-with-border" action="{{route('ourtrips.store')}}" method="POST">
                                        @csrf
                                        ...
                                        <div class="tourmaster-column-30 tourmaster-search-price-column-left">
                                            <div class="tourmaster-tour-search-field tourmaster-tour-search-field-min-price">
                                                <label class="gdlr-core-skin-title">Min Price</label><input name="min-price" type="text" step="0.01" value="{{ old('min-price') }}"/>
                                            </div>
                                        </div>
                                        <div class="tourmaster-column-30 tourmaster-search-price-column-right">
                                            <div class="tourmaster-tour-search-field tourmaster-tour-search-field-max-price">
                                                <label class="gdlr-core-skin-title">Max Price</label><input name="max-price" type="text"  step="0.01" value="{{ old('max-price') }}" />
                                            </div>
                                        </div>
                                        <div class="clear"></div>
                                ...
                                <form action="{{ route('tripcruds.store') }}" method="POST" enctype="multipart/form-data" class="trip-form">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control input-field" name="image" id="image">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control input-field" name="duration" id="duration" required>
                                        </div>
                                    
                                        <div class="form-group">
                                            <label for="availability" class="label-field">Availability</label>
                                            <input type="text" class="form-control input-field" name="availability" id="availability" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-field" name="location" id="location" required>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control input-field" name="reviews_count" id="reviews_count" value="0" required>
                                        </div>
                                    
                                        <div class="form-group">
                                            <label for="price" class="label-field">Price</label>
                                            <input type="number" step="0.01" class="form-control input-field" name="price" id="price" required>
                                        </div>
                                    </div>
                                   ...
                                   <div class="tourmaster-tour-grid tourmaster-tour-frame tourmaster-tour-grid-style-2 tourmaster-price-right-title">
                                       <div class="tourmaster-tour-grid-inner"
                                           ...
                                           <div class="tourmaster-tour-thumbnail tourmaster-media-image gdlr-core-outer-frame-element">
                                               <img src="{{ asset('storage/' . $ourtripcrud->image) }}" alt="" width="700" height="500" />
                                           </div>
                            
                                           <div class="tourmaster-tour-content-wrap gdlr-core-skin-e-background gdlr-core-js" data-sync-height="tour-item-40">
                                               
                                            
                                               <div class="tourmaster-icons" style="position: absolute; top: 10px; right: 10px; z-index: 10;">
                                                   <a href="{{route('tripcruds.edit',$ourtripcrud->id)}}" class="tourmaster-edit-icon" style="margin-right: 10px;">
                                                       <i class="fa fa-edit" style="color: #48bf84;"></i>
                                                   </a>
                                        
                                                   <form id="delete-form-{{ $ourtripcrud->id }}" action="{{ route('tripcruds.destroy', $ourtripcrud->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" class="tourmaster-delete-icon" style="background: none; border: none; cursor: pointer; transition: transform 0.3s, background-color 0.3s;" onclick="confirmDelete({{ $ourtripcrud->id }})">
                                                        <i class="fa fa-trash" style="color: #48bf84;"></i>
                                                    </button>
                                                </form>
                                               </div>
                                               ...
                                               <div class="tourmaster-tour-price-wrap" style="margin-top: 50px; margin-bottom: 25px;">
                                                   <span class="tourmaster-tour-price" style="font-size: 18px; font-weight: bold; color: #48bf84; display: block; margin-top: 50px !important;">
                                                       <span class="tourmaster-head">From</span>
                                                       <span class="tourmaster-tail">${{ $ourtripcrud->price }}</span>
                                                   </span>
                                               </div>
                                               ...
                                               <div class="tourmaster-tour-info-wrap clearfix">
                                                   <div class="tourmaster-tour-info tourmaster-tour-info-duration-text">
                                                       <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 465 465" xml:space="preserve">
                                                           <path d="M279.591,423.714c-3.836,0.956-7.747,1.805-11.629,2.52c-10.148,1.887-16.857,11.647-14.98,21.804 c0.927,4.997,3.765,9.159,7.618,11.876c3.971,2.795,9.025,4.057,14.175,3.099c4.623-0.858,9.282-1.867,13.854-3.008 c10.021-2.494,16.126-12.646,13.626-22.662C299.761,427.318,289.618,421.218,279.591,423.714z"></path>
                                                       </svg>
                                                       {{ $ourtripcrud->duration }} days
                                                   </div>
                            
                                                   <div class="tourmaster-tour-info tourmaster-tour-info-availability">
                                                       <i class="fa fa-calendar"></i> Availability: {{ $ourtripcrud->availability }}
                                                   </div>
                                                   <div class="tourmaster-tour-info tourmaster-tour-info-departure-location">
                                                       <i class="flaticon-takeoff-the-plane"></i> {{ $ourtripcrud->location }}
                                                   </div>
                                               </div>
                            
                                               <div class="tourmaster-tour-description">
                                                   <i class="fa fa-file-text icon-description" style="margin-right: 10px;"></i> 
                                                   {{ $ourtripcrud->description }}
                                               </div>
                            
                                               <div class="tourmaster-tour-rating">
                                                   @for ($i = 0; $i < 5; $i++)
                                                       <i class="fa fa-star{{ $i < $ourtripcrud->reviews_count ? '' : '-o' }}"></i>
                                                   @endfor
                                                   <span class="tourmaster-tour-rating-text">({{ $ourtripcrud->reviews_count }} Reviews)</span>
                                               </div>
                            
                                               <div class="tourmaster-tour-booking" style="text-align: center;">
                                                   <button class="tourmaster-button" onclick="openModal({{ $ourtripcrud->id }})" style="padding: 10px; background-color: #48bf84; color: white; border-radius: 5px;">
                                                      Book Now 
                                                   </button>
                                               </div>
                                           </div>
                            ...
                            @endforeach
                               ...
                               <div id="bookingModal" class="modal">
                                <div class="modal-content">
                                 ...
                                 <input type="number" name="numberofpeople" placeholder="Number of People" required style="width: 100%; padding: 10px; margin-bottom: 10px;">
                                 ...
                                 <button type="submit" class="tourmaster-button" style="padding: 10px; background-color: #48bf84; color: white; border-radius: 5px;">
                                     Submit Booking 
                                 </button>
                                 </form>
                             </div>
